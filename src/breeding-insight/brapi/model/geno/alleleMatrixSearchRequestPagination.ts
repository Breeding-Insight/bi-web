...
export interface AlleleMatrixSearchRequestPagination { 
    /**
     * the dimension of the matrix being paginated
     */
    dimension?: AlleleMatrixSearchRequestPagination.DimensionEnum;
    /**
...
export namespace AlleleMatrixSearchRequestPagination {
    export type DimensionEnum = 'CALLSETS' | 'VARIANTS';
    export const DimensionEnum = {
        CALLSETS: 'CALLSETS' as DimensionEnum,
        VARIANTS: 'VARIANTS' as DimensionEnum
    };
}