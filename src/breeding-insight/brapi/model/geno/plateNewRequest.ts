...
export interface PlateNewRequest { 
    /**
     ...
     */
    plateFormat?: PlateNewRequest.PlateFormatEnum;
    /**
     ...
     */
    sampleType?: PlateNewRequest.SampleTypeEnum;
    /**
...
export namespace PlateNewRequest {
    export type PlateFormatEnum = 'PLATE_96' | 'TUBES';
    export const PlateFormatEnum = {
        PLATE96: 'PLATE_96' as PlateFormatEnum,
        TUBES: 'TUBES' as PlateFormatEnum
    };
    export type SampleTypeEnum = 'DNA' | 'RNA' | 'TISSUE' | 'MIXED';
    export const SampleTypeEnum = {
        DNA: 'DNA' as SampleTypeEnum,
        RNA: 'RNA' as SampleTypeEnum,
        TISSUE: 'TISSUE' as SampleTypeEnum,
        MIXED: 'MIXED' as SampleTypeEnum
    };
}