 ...
 */
export interface VariantSetAvailableFormats { 
    /**
     * dataFormat defines the structure of the data within a file (ie DartSeq, VCF, Hapmap, tabular, etc)
     */
    dataFormat?: VariantSetAvailableFormats.DataFormatEnum;
    /**
     ...
     */
    fileFormat?: VariantSetAvailableFormats.FileFormatEnum;
    /**
...
export namespace VariantSetAvailableFormats {
