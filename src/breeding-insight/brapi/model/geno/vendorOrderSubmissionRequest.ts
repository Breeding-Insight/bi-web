 ...
 */
import { VendorOrderSubmissionRequestPlates } from './vendorOrderSubmissionRequestPlates';

/**
 * Request object structure to submit plate data to a vendor
 */
export interface VendorOrderSubmissionRequest { 
    /**
...
export namespace VendorOrderSubmissionRequest {
    export type SampleTypeEnum = 'DNA' | 'RNA' | 'Tissue';
