 ...
 */
import { VendorOrderSubmissionRequestSamples } from './vendorOrderSubmissionRequestSamples';

export interface VendorOrderSubmissionRequestPlates { 
    /**
     ...
     */
    clientPlateId?: string;
    /**
     * Enum for plate formats, usually \"PLATE_96\" for a 96 well plate or \"TUBES\" for plateless format
     */
    sampleSubmissionFormat?: VendorOrderSubmissionRequestPlates.SampleSubmissionFormatEnum;
    samples?: Array<VendorOrderSubmissionRequestSamples>;
}
export namespace VendorOrderSubmissionRequestPlates {
    export type SampleSubmissionFormatEnum = 'PLATE_96' | 'TUBES';
    export const SampleSubmissionFormatEnum = {
        PLATE96: 'PLATE_96' as SampleSubmissionFormatEnum,
        TUBES: 'TUBES' as SampleSubmissionFormatEnum
    };
}