...
import { VendorOrderSubmissionRequestConcentration } from './vendorOrderSubmissionRequestConcentration';

export interface VendorOrderSubmissionRequestSamples { 
    /**
     * (Optional) The value of the bar code attached to this sample
     */
    clientSampleBarCode?: string;
    /**
     ...
     */
    comments?: string;
    concentration?: VendorOrderSubmissionRequestConcentration;
    /**
     ...
     */
    speciesName?: string;
    taxonomyOntologyReference?: MethodBaseClassOntologyReference;
    /**
     * The type of tissue in this sample. List of accepted tissue types can be found in the Vendor Specs.
     */
    tissueType?: string;
    tissueTypeOntologyReference?: MethodBaseClassOntologyReference;
    volume?: VendorOrderSubmissionRequestConcentration;
    /**
