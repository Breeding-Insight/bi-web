 ...
 */
import { VendorSpecificationServiceSpecificRequirements } from './vendorSpecificationServiceSpecificRequirements';

export interface VendorSpecificationService { 
    /**
     ...
     */
    servicePlatformMarkerType?: VendorSpecificationService.ServicePlatformMarkerTypeEnum;
    /**
     ...
     */
    specificRequirements?: Array<VendorSpecificationServiceSpecificRequirements>;
}
export namespace VendorSpecificationService {
    export type ServicePlatformMarkerTypeEnum = 'FIXED' | 'DISCOVERABLE';
    export const ServicePlatformMarkerTypeEnum = {
        FIXED: 'FIXED' as ServicePlatformMarkerTypeEnum,
        DISCOVERABLE: 'DISCOVERABLE' as ServicePlatformMarkerTypeEnum
    };
}