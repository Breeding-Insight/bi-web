...
<template>
  <section id="programUserTableLabel">
    ...
    >
      <b-table-column field="data.name" label="Name" sortable v-slot="props" th-attrs="scope='col'">
        {{ props.row.data.name }}
      </b-table-column>
      <b-table-column field="data.email" label="Email" sortable v-slot="props">
        {{ props.row.data.email }}
      </b-table-column>
      <b-table-column :custom-sort="sortRole" label="Roles" sortable v-slot="props">
